"""
components/catalogo_fitoplancton_ui.py
UI reutilizable del catálogo de taxonomía de fitoplancton (tabla
taxonomia_fitoplancton).

Se renderiza como una sección dentro de la página de Parámetros / ECAs
(pestaña "Catálogo fitoplancton") y también desde la página standalone
pages/11_Catalogo_Fitoplancton.py. Mantener la lógica aquí evita duplicarla
entre ambos puntos de entrada.
...
from components.ui_styles import section_header
...
# ─────────────────────────────────────────────────────────────────────────────
# Subsección — Listado del catálogo
# ─────────────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# Subsección — Nueva especie (con verificación AlgaeBase / GBIF)
# ─────────────────────────────────────────────────────────────────────────────
...
def render_catalogo_fitoplancton() -> None:
    """
    Renderiza el catálogo de fitoplancton (sub-pestañas Catálogo / Nueva especie).
    Pensado para incrustarse dentro de la página de Parámetros / ECAs.
    """
